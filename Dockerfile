...
FROM ghcr.io/kairos-io/hadron-sources/musl-toolchain:1.2.5 AS musl-toolchain-download
...
FROM ghcr.io/kairos-io/hadron-sources/curl:8.21.0 AS curl-download
FROM ghcr.io/kairos-io/hadron-sources/rsync:3.4.4 AS rsync-download
FROM ghcr.io/kairos-io/hadron-sources/xxhash:0.8.3 AS xxhash-download
FROM ghcr.io/kairos-io/hadron-sources/zstd:1.5.7 AS zstd-download
FROM ghcr.io/kairos-io/hadron-sources/lz4:1.10.0 AS lz4-download
FROM ghcr.io/kairos-io/hadron-sources/zlib:1.3.2 AS zlib-download
FROM ghcr.io/kairos-io/hadron-sources/acl:2.4.0 AS acl-download
FROM ghcr.io/kairos-io/hadron-sources/attr:2.6.0 AS attr-download
FROM ghcr.io/kairos-io/hadron-sources/gawk:5.4.1 AS gawk-download
FROM ghcr.io/kairos-io/hadron-sources/ca-certificates:20260611 AS ca-certificates-download
FROM ghcr.io/kairos-io/hadron-sources/systemd:261.2 AS systemd-download
FROM ghcr.io/kairos-io/hadron-sources/libcap:2.78 AS libcap-download

FROM ghcr.io/kairos-io/hadron-sources/util-linux:2.42.2 AS util-linux-download
FROM ghcr.io/kairos-io/hadron-sources/python:3.14.6 AS python-download
FROM ghcr.io/kairos-io/hadron-sources/sqlite3:3.53.4 AS sqlite3-download
FROM ghcr.io/kairos-io/hadron-sources/openssl:3.6.3 AS openssl-download
FROM ghcr.io/kairos-io/hadron-sources/openssl-fips:3.1.2 AS openssl-fips-download
FROM ghcr.io/kairos-io/hadron-sources/openssh:10.4p1 AS openssh-download
FROM ghcr.io/kairos-io/hadron-sources/pkgconf:3.0.5 AS pkgconf-download
FROM ghcr.io/kairos-io/hadron-sources/dbus:1.16.2 AS dbus-download
FROM ghcr.io/kairos-io/hadron-sources/expat:2.8.2 AS expat-download
FROM ghcr.io/kairos-io/hadron-sources/libseccomp:2.6.1 AS libseccomp-download
FROM ghcr.io/kairos-io/hadron-sources/strace:7.1 AS strace-download
FROM ghcr.io/kairos-io/hadron-sources/kbd:2.10.0 AS kbd-download
FROM ghcr.io/kairos-io/hadron-sources/iptables:1.8.13 AS iptables-download
FROM ghcr.io/kairos-io/hadron-sources/libmnl:1.0.5 AS libmnl-download
FROM ghcr.io/kairos-io/hadron-sources/libnftnl:1.3.1 AS libnftnl-download
FROM ghcr.io/kairos-io/hadron-sources/libnfnetlink:1.0.2 AS libnfnetlink-download
FROM ghcr.io/kairos-io/hadron-sources/libnetfilter_conntrack:1.1.1 AS libnetfilter_conntrack-download
FROM ghcr.io/kairos-io/hadron-sources/libnetfilter_cttimeout:1.0.1 AS libnetfilter_cttimeout-download
FROM ghcr.io/kairos-io/hadron-sources/libnetfilter_cthelper:1.0.1 AS libnetfilter_cthelper-download
FROM ghcr.io/kairos-io/hadron-sources/libnetfilter_queue:1.0.5 AS libnetfilter_queue-download
FROM ghcr.io/kairos-io/hadron-sources/conntrack-tools:1.4.9 AS conntrack-tools-download
FROM ghcr.io/kairos-io/hadron-sources/procps-ng:4.0.6 AS procps-ng-download
FROM ghcr.io/kairos-io/hadron-sources/linux:7.1.8 AS linux-download
FROM ghcr.io/kairos-io/hadron-sources/flex:2.6.4 AS flex-download
FROM ghcr.io/kairos-io/hadron-sources/bison:3.8.2 AS bison-download
FROM ghcr.io/kairos-io/hadron-sources/autoconf:2.73 AS autoconf-download
FROM ghcr.io/kairos-io/hadron-sources/automake:1.18.1 AS automake-download
FROM ghcr.io/kairos-io/hadron-sources/musl-fts:1.2.7 AS musl-fts-download
FROM ghcr.io/kairos-io/hadron-sources/libtool:2.5.4 AS libtool-download
FROM ghcr.io/kairos-io/hadron-sources/libelf:0.195 AS libelf-download
FROM ghcr.io/kairos-io/hadron-sources/xz:5.8.3 AS xz-download
FROM ghcr.io/kairos-io/hadron-sources/kmod:34.2 AS kmod-download
FROM ghcr.io/kairos-io/hadron-sources/dracut:112 AS dracut-download
FROM ghcr.io/kairos-io/hadron-sources/libaio:0.3.113 AS libaio-download
FROM ghcr.io/kairos-io/hadron-sources/lvm2:2.03.41 AS lvm2-download
FROM ghcr.io/kairos-io/hadron-sources/multipath-tools:0.15.0 AS multipath-tools-download
FROM ghcr.io/kairos-io/hadron-sources/json-c:0.19 AS json-c-download
FROM ghcr.io/kairos-io/hadron-sources/cmake:4.4.2 AS cmake-download
FROM ghcr.io/kairos-io/hadron-sources/dwarves:1.31 AS dwarves-download
FROM ghcr.io/kairos-io/hadron-sources/libbpf:1.5.0 AS libbpf-download
FROM ghcr.io/kairos-io/hadron-sources/argp-standalone:1.4.1 AS argp-standalone-download
FROM ghcr.io/kairos-io/hadron-sources/musl-obstack:1.2.3 AS musl-obstack-download
FROM ghcr.io/kairos-io/hadron-sources/elfutils:0.195 AS elfutils-download
FROM ghcr.io/kairos-io/hadron-sources/urcu:0.15.6 AS urcu-download
FROM ghcr.io/kairos-io/hadron-sources/parted:3.7 AS parted-download
FROM ghcr.io/kairos-io/hadron-sources/e2fsprogs:1.47.4 AS e2fsprogs-download
FROM ghcr.io/kairos-io/hadron-sources/dosfstools:4.2 AS dosfstools-download
FROM ghcr.io/kairos-io/hadron-sources/libtirpc:1.3.7 AS libtirpc-download
FROM ghcr.io/kairos-io/hadron-sources/libnl:3.12.0 AS libnl-download
FROM ghcr.io/kairos-io/hadron-sources/libevent:2.1.13 AS libevent-download
FROM ghcr.io/kairos-io/hadron-sources/keyutils:1.6.3 AS keyutils-download
FROM ghcr.io/kairos-io/hadron-sources/nfs-utils:2.9.2 AS nfs-utils-download
FROM ghcr.io/kairos-io/hadron-sources/cryptsetup:2.8.7 AS cryptsetup-download
FROM ghcr.io/kairos-io/hadron-sources/grub:2.14 AS grub-download
FROM ghcr.io/kairos-io/hadron-sources/pam:1.7.2 AS pam-download
FROM ghcr.io/kairos-io/hadron-sources/shadow:4.20.0 AS shadow-download
FROM ghcr.io/kairos-io/hadron-sources/aports:3.24.1 AS aports-download
FROM ghcr.io/kairos-io/hadron-sources/busybox:1.37.0 AS busybox-download
FROM ghcr.io/kairos-io/hadron-sources/musl:1.2.6 AS musl-download
FROM ghcr.io/kairos-io/hadron-sources/gcc:15.3.0 AS gcc-download
FROM ghcr.io/kairos-io/hadron-sources/gmp:6.3.0 AS gmp-download
FROM ghcr.io/kairos-io/hadron-sources/mpc:1.4.1 AS mpc-download
FROM ghcr.io/kairos-io/hadron-sources/mpfr:4.2.2 AS mpfr-download
FROM ghcr.io/kairos-io/hadron-sources/make:4.4.1 AS make-download
FROM ghcr.io/kairos-io/hadron-sources/binutils:2.47 AS binutils-download
FROM ghcr.io/kairos-io/hadron-sources/popt:1.19 AS popt-download
FROM ghcr.io/kairos-io/hadron-sources/m4:1.4.21 AS m4-download
FROM ghcr.io/kairos-io/hadron-sources/readline:8.3 AS readline-download
FROM ghcr.io/kairos-io/hadron-sources/perl:5.44.0 AS perl-download
FROM ghcr.io/kairos-io/hadron-sources/coreutils:9.11 AS coreutils-download
FROM ghcr.io/kairos-io/hadron-sources/findutils:4.11.0 AS findutils-download
FROM ghcr.io/kairos-io/hadron-sources/grep:3.12 AS grep-download
FROM ghcr.io/kairos-io/hadron-sources/gperf:3.3 AS gperf-download
FROM ghcr.io/kairos-io/hadron-sources/diffutils:3.12 AS diffutils-download
FROM ghcr.io/kairos-io/hadron-sources/sudo:1.9.17p2 AS sudo-download
FROM ghcr.io/kairos-io/hadron-sources/pax-utils:1.3.11 AS pax-utils-download
FROM ghcr.io/kairos-io/hadron-sources/openscsi:2.1.12 AS openscsi-download
FROM ghcr.io/kairos-io/hadron-sources/gdb:17.2 AS gdb-download
FROM ghcr.io/kairos-io/hadron-sources/libffi:3.7.1 AS libffi-download
FROM ghcr.io/kairos-io/hadron-sources/tpm2-tss:4.2.0 AS tpm2-tss-download
FROM ghcr.io/kairos-io/hadron-sources/libucontext:1.5.2 AS libucontext-download
FROM ghcr.io/kairos-io/hadron-sources/libxml2:2.15.3 AS libxml2-download
FROM ghcr.io/kairos-io/hadron-sources/gzip:1.14 AS gzip-download
...
FROM ghcr.io/kairos-io/hadron-sources/libkcapi:1.5.0 AS libkcapi-download
FROM ghcr.io/kairos-io/hadron-sources/shim:16.1 AS shim-download
FROM ghcr.io/kairos-io/hadron-sources/libiconv:1.19 AS libiconv-download
FROM ghcr.io/kairos-io/hadron-sources/bc:7.1.0 AS bc-download
FROM ghcr.io/kairos-io/hadron-sources/patch:2.8 AS patch-download
FROM ghcr.io/kairos-io/hadron-sources/pcre2:10.47 AS pcre2-download
FROM ghcr.io/kairos-io/hadron-sources/glib:2.86.2 AS glib-download
FROM ghcr.io/kairos-io/hadron-sources/qemu:10.1.5 AS qemu-download
FROM ghcr.io/kairos-io/hadron-sources/mspack:1.11 AS mspack-download
FROM ghcr.io/kairos-io/hadron-sources/open-vm-tools:13.1.0 AS open-vm-tools-download
...
RUN make -s -j${JOBS} -l${MAX_LOAD} && make -s -j1 install_device-mapper DESTDIR=/lvm2
